...
Enemy* ClassManager::createEnemyInstance(const string& enemyTypeName)
{
    if(enemyTypeName == "Badger"){
            return new Enemy(10,1,500, "/Sprites/Badger/Gray/badger_01_smallani.png", 50, 50, 2, 5);
    }else if(enemyTypeName == "RedBadger"){
            return new Enemy(20,1,500, "/Sprites/Badger/Red/badger_02_smallani.png", 50, 50, 2, 5);
    }else if(enemyTypeName == "BlueBadger"){
            return new Enemy(30,2,500, "/Sprites/Badger/Blue/badger_01_smallani.png", 50, 50, 2, 5);
    }
    return NULL;
}
